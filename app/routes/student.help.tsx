...
export default function StudentHelp() {
  ...
  const [chatHistory, setChatHistory] = useState([
    { id: 1, text: "שלום יוסי! איך אפשר לעזור לך היום?", sender: 'bot', time: '10:00' }
  ]);
  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setChatHistory(prev => [...prev, {
        id: Date.now() + 1,
        text: "תודה על פנייתך. נציג תמיכה יתחבר מיד לשיחה...",
        sender: 'bot',
    ...
    <MainLayout portalName="פורטל סטודנטים" view="student">
      <div className="space-y-8 animate-in fade-in duration-500 max-w-6xl mx-auto pb-12 min-h-[101vh]">
        <header className="border-b border-gray-200 pb-6">
          ...
          <p className="text-gray-500 mt-2 text-lg">כאן תוכל למצוא תשובות לשאלות נפוצות או לשוחח עם התמיכה.</p>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl border border-gray-200 flex flex-col h-[600px] overflow-hidden">
            <div className="bg-[#00857e] p-4 text-white flex items-center gap-3">
              ...
              <div>
                <h2 className="font-extrabold text-lg">צ'אט תמיכה</h2>
                <p className="text-teal-100 text-sm">מענה מהיר לכל בעיה</p>
              </div>
            </div>
