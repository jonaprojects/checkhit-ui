        ...
        <header className="border-b border-gray-200 pb-6">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-gray-500">פרופ׳ כהן | סמסטר א׳ תשפ״ד</p>
            </div>
          </div>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <h2 className="text-xl font-bold text-gray-800 flex items-center gap-2">
              <FileText className="text-[#00857e]" /> מטלות הקורס
            </h2>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
              ...
              {resources.map(resource => (
                <div key={resource.id} className="flex items-center justify-between p-3 rounded-xl border border-gray-100 bg-gray-50/50 hover:bg-gray-50 transition-colors group cursor-pointer">
                  ...
                  <button className="text-gray-400 hover:text-[#00857e] transition-colors">
                    <Download size={18} />
                  </button>
                </div>
              ))}
